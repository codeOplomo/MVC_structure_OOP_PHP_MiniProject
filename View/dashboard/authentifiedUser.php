...
<head>
    ...
    <link href="../../Assets/css/authentifiedUser.css" rel="stylesheet">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Tasks manager</h6>
                                                            ...
                                                            <table class="table text-white mb-0">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="fw-normal">
                                                                        ...
                                                                        <td class="align-middle">Make payment to
                                                                            Bluedart</td>
                                                                        <td class="align-middle">
                                                                            <h6 class="mb-0"><span
                                                                                    class="badge bg-success">Low
                                                                                    priority</span></h6>
                                                                        </td>
                                                                        <td class="align-middle">
                                                                            <a href="#!" data-mdb-toggle="tooltip"
                                                                    ...
                                                                    <tr class="fw-normal">
                                                                        ...
                                                                        <td class="align-middle">Office grocery shopping
                                                                        </td>
                                                                        <td class="align-middle">
                                                                            <h6 class="mb-0"><span
                                                                                    class="badge bg-danger">High
                                                                    ...
                                                                    <tr class="fw-normal">
                                                                        ...
                                                                        <td class="border-0 align-middle">Ask for Lunch
                                                                            to Clients</td>
